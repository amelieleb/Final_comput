...
Les récifs coralliens sont grandement affectés par des perturbations
anthropiques mettant en péril leur survie. Bien qu'il existe déjà
...
L'équipe de recherche de Torres et al. se sont toutefois intéressé sur
...
importances relatives associées à la reproduction asexuée ainsi qu'au
recrutement des larves pélagiques de corail en provenance locale ou
externe qui pourrait être utilisé sur des communautés de populations
...
Polynésie française. à la suite d'une diminution presque complète du récif en
...
Polynésie française, entre 2010 et 2019, à la suite d'un déclin important de
leur abondance?
...
croissance asexuée des individus matures déjà présents dans la
sous-population.

Hypothèse 2: La croissance de la population est influencée par la
reproduction sexuée dûe au recrutement de larves de provenance
autochtone, c'est-à-dire situées à 1-100m de la sous-population.

Hypothèse 3: La croissance de la population est influencée par la
reproduction sexuée dûe au recrutement de larves de provenance locale,
c'est-à-dire situées à 100m - 10km de la sous-population (sous-population
à proximité).
...
récif corallien Moorea en Polynésie française ont été récoltées dans le
cadre d'un projet de séries chronologiques et écologiques à long terme du
...
recueillies sur divers sites et études:

-   La valeur de fécondité est une moyenne normalisée de plusieurs
...
Afin de calculer les cas limites et intermédiaires d'une population, voici le
modèle utilisé:
...
populaion normalisée (dP\*~1~) sur un échelle de temps intrinsèque
...
Chacun de ces paramètres peuvent être déterminés à partir des équations
suivantes:
...
*Immigration nette normalisée:* $$I^* = \frac{I}{SK}$$

*Croissance nette du processus asexué et de la mortalité de la
...
La capacité de soutien est déterminée par une combinaison de facteurs
locaux tels que la prédation, les maladies et la compétition.
...
Pour le modèle des cas-limites, nous considérons que le taux de croissance $r$ est identique dans le deux population (r1=r2=1), tout comme la capacité de soutien (K1=K2=1).

<br>

*Modèle de croissance des sous-populations*
...
Les sous-populations inclues dans le modèle sont liées à une
métapopulation stable qui permet un apport constant de larves dans une
...
Le substrat disponible pour la croissance est limité.
...
model_cas_limite <- function(t, state, parameters) {
  ...
  #Croissance normalisée de la population dû au recrutement allochtone
...
Le graphique des cas limites et intermédiaires représente des trajectoires de rétablissement de populations de coraux lorsque les deux sous-populations sont supposées être identiques, donc que leur abondances initiales sont de P1=P2=1, que K1=K2=1 et que r1=r2=1. Ainsi, lorsque les paramètres sont invariants dans le temps, la taille de la population devrait être reliée à différents facteurs selon la croissance nette ($\Gamma$).

Lorsque $\Gamma$ = 0, le recrutement de larve allochtone devrait avoir un plus grand impact sur la croissance, en faisant augmenter la taille de la population très rapidement avant de s'immobiliser au seuil K.
...
Pour le cas d'une sous-population d'avant-récif qui est très efficace pour se rétablir après une perturbation forte, le modèle `model_proportion_backreef` a permis d'évaluer la dynamique d'un récif corallien qui croît grâce à différentes sources larvaires. Dans ce cas, on observe que le pourcentage de recouvrement en corail du subtrat est principalement dû au recrutement larvaire des sous-populations autres, grâce à l'immigration via l'après-récif et d'ailleurs.

Toutefois, le graphique du pourcentage de la capacité de charge des populations par an permet d'évaluer la contribution de chaque facteurs de croissance pendant le rétablissement de la sous-population. Pour ce qui est de l'apport extérieur, on remarque alors que les échanges locaux, donc entre l'avant-récif et l'après-récif, ont très peu d'impact contrairement à l'immigration nette qui est la plus importante directement après la perturbation. Pour ce qui est de l'apport intrinsèque, la croissance asexuée et l'auto-recrutement en larves dominent les autres facteurs contribuant 2 à 3 ans après la perturbation.
...
L'après-récif a aussi été modélisé avec `model_proportion_backreef`, puisque les deux sous-populations réagissent différement aux perturbations. En effet, plutôt que de croître comme la sous-population d'avant-récif, l'arrière-récif a un pourcentage de recouvrement corallien qui diminue. Et bien que l'immigration reste constante et très faible (%K/yr < 0.1), la courbe de mortalité augmente plus les années passent. 
...
La figure 3a représentent l'évolution d'une sous-population d'avant-récif qui a un fort effet de rétablissement après une population. De manière générale entre les années, le recrutement larvaire allochtone jumelé à l'immigration nette a un plus fort impact que le recrutement larvaire autochtone et la reproduction asexuée. Toutes les composantes influencent quand même la croissance de la population.

Toutefois, la figure 3c démontre l'importance relative de chacun des facteurs (reproduction asexuée, recrutement autochtone, recrutement local et recrutement allochtone) dans le rétablissement de la population. Au début, c'est l'immigration nette qui a un grand impact sur la repopulation de l'avant-récif, mais il semble qu'une fois que l'abondance s'élève, ce sera plutôt la reproduction asexuée et le recrutement autochtone qui joueront un rôle dans le maintien d'une population croissante. Or, précisément en 2013, la croissance asexuée
...
Quant à elle, la figure 4a représente une reconstruction de trajectoire de population sur un site de l'après-récif qui est en déclin. Comme il est expliqué dans l'article de Torres et al., il y a une forte compétition entre les coraux et les microalgues dans l'après-récif, ne facilitant donc pas l'augmentation de l'abondance de coraux. 
