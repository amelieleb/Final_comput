...
2012). Sur toute la planète, le réchauffement des océans par les
changements climatiques et l’acidification des eaux peuvent entraîner le
blanchissement du corail et plusieurs maladies (Huang, 2012). Avec
...
(Torres et al., 2025). Le temps spécifique afin que la population
récupère varie selon la proportion d’individus, soit la proportion de
polypes viables, qui n’ont pas été affecté après la perturbation.
...
plusieurs années, soit de 2010 à 2018, où la perturbation venait tout
juste d’arriver. Les abondances des populations commençaient donc à une
très petite échelle et récupéraient jusqu’en 2018. Or, avec les
résultats de cette recherche, nous nous sommes intéressés aux
différentes abondances de population après une perturbation, plus
précisément aux différences qu’il peut exister entre la récupération
d’une sous-population de coraux après une perturbation plus forte, et
moins forte. Autrement dit, comment la grandeur de l’abondance de coraux
à la suite d’une perturbation plus ou moins forte change les courbes de
récupération des différentes sources (croissance asexuée, immigration,
autorecrutement, échange local)? Nous considérons que cette perspective
est importante afin de pousser la recherche puisque ce ne sont pas
toutes les perturbations qui affectent la même grandeur de population de
coraux. En effet, être en mesure de modéliser la récupération avec des
abondances différentes pourrait nous permettre d’avoir une meilleure
idée de la réaction des sous-populations de coraux à la suite de
perturbations d’ampleur différentes.
