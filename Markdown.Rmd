...
*Explication: Les nouveaux polypes proviennent de la reproduction asexuée chez les individus matures sessiles au sein des populations*
...
Avec les graphiques que nous avons obtenu, nous pouvons arriver à diverses interprétations. La figure 2 montre la trajectoire de récupération de la couverture corrallienne, selon la modélisation de deux sous-populations. Ce que l'on peut comprendre de a figure est que l'interaction qui existe entre l'auto-recrutement et l'immigration affecte fortement la trajectoire de la récupération de la couverture corrallienne. Cette trajectoire est représentée par la courbe de la population allochtone. 
