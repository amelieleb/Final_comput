...
Pour le modèle des cas-limites, sont considère que le taux de croissance
$r$ est identique dans le deux population
(\$r$1=$r$2=1), tout comme la capacité de soutien ($K$1=$K\$2=1).
...
![](Figure%202.png) ![](Figure%203a.png) ![](Figure%203c.png)
![](Figure%204a.png) ![](Figure%204c.png)
...
nous démontrent la croissance totale de la population (en noir),
provenant des sources autochtones (en bleu) et allochtones (en jaune).
De plus, les figures 3c et 3d représentent les composants contribuant au
changement de la croissance de la population aux deux mêmes sites du
récif avant. Les figures 4a et 4b représentent des reconstructions des
trajectoires de population sur deux sites du récif arrière. Les figures
4c et 4d représentent les composants contribuant aux changements de la
croissance de la population. Si l’on regarde de manière générale à
travers ces graphiques, nous pouvons voir que le récif avant est
beaucoup plus propice à la prolifération asexuée que le récif arrière.
...
larves provenant du récif avant. De plus, étant donné que les différents
...
augmente jusqu’à se stabiliser également. Pour ce qui est du récif
avant, nous pouvons voir dans les graphiques 3a et 3b, autant l’apport
allochtone que l’apport autochtone contribue à l’accroissement de la
population. D’autre part, les figures 3c et 3d nous démontrent que dans
les premières années, c’est l’immigration qui permet un apport plus
grand à la population. Or, précisément en 2013, la croissance asexuée
...
Avec l’observation des graphiques et l’interprétation biologique
découlant de ceux-ci, nous pouvons confirmer notre première hypothèse
soutenant que la croissance de la population est influencée davantage
par la croissance asexuée des individus matures déjà présents dans la
sous-population. Ce type de croissance surpasse largement l’immigration.
L’autorecrutement dépasse également l’immigration à long terme, mais
c’est tout de même la croissance asexuée des polypes qui est la plus
influente.
